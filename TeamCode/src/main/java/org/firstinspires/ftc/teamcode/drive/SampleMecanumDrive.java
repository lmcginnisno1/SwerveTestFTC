...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    //private static double  angoff= Constants.startingAngle;

    private static double angoff=Math.PI/2;
...
//fix raw heading quadrant issues
    ...
    public double AngleError(double target, int fwdrev){
        target %=360;
        double err=target-getDegrees();
        if(err>=180){
            err-=360;
        }else if (err<-180){
            err+=360;
    ...
    public double AngleDelta(double ang1, double ang2){
