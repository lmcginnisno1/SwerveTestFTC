...
public class Pipeline_Detect3ColorInSamePlace extends OpenCvPipeline {
    /*
    ...
    static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(330,375);
    ...
    public Mat processFrame(Mat input)
    {
        ...
        /*
         * Now we need to determine what the average color is closet to
         */
        if(avg1 > 165) // Was it red?
        {
