...
import org.firstinspires.ftc.teamcode.first.math.trajectory.TrapezoidProfile.State;
//import org.firstinspires.ftc.teamcode.ftclib.util.ErrorMessages.requireNonNullParam;
...
public abstract class ProfiledPIDSubsystem extends SubsystemBase {
    ...
    public ProfiledPIDSubsystem(ProfiledPIDController controller, double initialPosition) {
        // hiep-couldn't get requireNonNullParam to work, remove for now
