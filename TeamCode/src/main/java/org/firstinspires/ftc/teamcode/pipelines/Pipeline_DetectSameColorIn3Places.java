...
public class Pipeline_DetectSameColorIn3Places extends OpenCvPipeline {
    /*
        ...
        The team shipping element color is compared against the empty gray playing field
     */
     ...
     */
    static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(23,330);
    static final Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(300,330);
    static final Point REGION3_TOPLEFT_ANCHOR_POINT = new Point(577,330);
